...
#ifndef __EMSCRIPTEN__
  GL(glFramebufferTexture3D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_3D, t.getId(), 0,
                            GLint(slice)));
#else
  GL(glFramebufferTextureLayer(GL_FRAMEBUFFER,GL_COLOR_ATTACHMENT0, t.getId(), 0, GLint(slice)));
#endif
...
void GLFramebuffer::unbind3D() {
  ...
  GL(glFramebufferTextureLayer(GL_FRAMEBUFFER,GL_COLOR_ATTACHMENT0, 0, 0, 0));
  GL(glFramebufferTextureLayer(GL_FRAMEBUFFER,GL_COLOR_ATTACHMENT1, 0, 0, 0));
  GL(glFramebufferTextureLayer(GL_FRAMEBUFFER,GL_COLOR_ATTACHMENT2, 0, 0, 0));
  GL(glFramebufferTextureLayer(GL_FRAMEBUFFER,GL_COLOR_ATTACHMENT2, 0, 0, 0));
#endif
